...
object RekamMedisEditDestination : DestinasiNavigasi {
    override val route = "medis_edit"
    override val titleRes = R.string.edit_rekamMedis
...
@Composable
fun RekamMedisEditScreen(
    navigateBack: () -> Unit,
    onNavigateUp: () -> Unit,
    modifier: Modifier = Modifier,
    viewModel: RekamMedisEditViewModel = viewModel(factory = PenyediaViewModel.Factory)
) {
    val coroutineScope = rememberCoroutineScope()
    Scaffold(
        topBar = {
            RsTopAppBar(
                title = stringResource(RekamMedisEditDestination.titleRes),
        ...
        EntryRekamMedisBody(
            uiStateRekamMedis = viewModel.rekamMedisUiState,
